...
<section id="aboutU" class="relative bg-theme-navy overflow-hidden pt-10 md:pt-0 flex-col-reverse flex">
...
<section class="py-12 md:py-16" id="ourProcess">
    <div class="container mx-auto">
        <div class="container mx-auto mb-12 md:mb-16 md:flex md:space-x-12 items-center">
            <div class="md:w-1/2">
                <img src="<?php echo get_template_directory_uri() ?>/assets/img/growth.webp" alt="" class="h-96 w-full object-cover object-left-top md:h-96 lg:w-full lg:h-full">
            </div>
            <div class="md:w-1/2">
                <div class="space-y-4">
