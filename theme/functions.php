...
if (!defined('STRATEGIC_SERVICES_TYPOGRAPHY_CLASSES')) {
	 ...
	 *
	 * For the front end, these classes are added by the `strategic_services_content_class`
	 ...
	 */
	define(
		'STRATEGIC_SERVICES_TYPOGRAPHY_CLASSES',
...
function strategic_services_scripts()
{
	...
	wp_enqueue_script('strategic-services-lg-script', get_template_directory_uri() . '/js/script.js', array(), STRATEGIC_SERVICES_VERSION, true);
